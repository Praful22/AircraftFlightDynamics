...
Mathematically, a system equilibrium pair $(\vec{x}_{eq},\vec{y}_{eq})$ would zero out the translational and rotational acceleration in translational and rotational equations of motion such that:
