...
Mathematically, a system equilibrium pair $$\( \vec{x}_{\text{eq}} \) , \( \vec{y}_{\text{eq}} \)$$ would zero out the translational and rotational acceleration in translational and rotational equations of motion such that:
